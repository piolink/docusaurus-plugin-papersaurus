...
const defaultCoverPageFunction = (siteConfig, _pluginConfig, pageTitle, _version, _language) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
const defaultPageHeaderFunction = (_siteConfig, pluginConfig, pageTitle, _version, _language) => {
    return `
...
const defaultPageFooterFunction = (_siteConfig, pluginConfig, _pageTitle, _version, _language) => {
    return `
...
const defaultPdfFileNameFunction = (_siteConfig, _pluginConfig, _pageTitle, pageId, _parentTitles, parentIds, _version, _versionPath, _language) => {
...
const schema = utils_validation_1.Joi.object({
    ...
    concurrency: utils_validation_1.Joi.number().default(os_1.default.cpus().length),
